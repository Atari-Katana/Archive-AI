...
- **[CLAUDE_CODE_HANDOFF.md](CLAUDE_CODE_HANDOFF.md)** - Mission, autonomy guidelines, David's preferences
- **[System Atlas v7.5](Archive-AI_System_Atlas_v7.5_REVISED.md)** - Architecture spec (THE GOSPEL)
- **[Implementation Plan](Archive-AI_Implementation_Plan_v7.5.md)** - 43-chunk work order
- **[PROGRESS.md](PROGRESS.md)** - Development progress tracker (79.1% complete)
- **[CONFIG.md](CONFIG.md)** - Configuration guide & deployment modes
